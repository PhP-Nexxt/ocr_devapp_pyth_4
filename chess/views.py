...
class View:
    ...
    def show_data(self, tournament):
        ...
        menu = SelectionMenu(
            a_list,
            "Le tournois à eu lieu à {} le "
            "{} en cadence {}".format(
                tournament.place, tournament.date, tournament.cadence
            ),
        )
        ...
        if selection == 0:
            ...
            classement_sort = sorted(
                classement_sort, key=attrgetter("ranking"), reverse=True
            )
